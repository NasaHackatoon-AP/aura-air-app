      ...
      <div className="bg-card border border-border rounded-lg p-3 shadow-lg">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs flex items-center gap-2">
            ...
            <span className="text-muted-foreground">{payload[1].value} μg/m³</span>
          </p>
        </div>
      </div>
    )
  ...
  return (
    <Card className="col-span-full">
      <CardHeader className="pb-3 sm:pb-6">
        <CardTitle className="text-base sm:text-lg">Histórico de Qualidade do Ar (24h)</CardTitle>
      ...
      <CardContent className="px-2 sm:px-6">
        <ResponsiveContainer width="100%" height={isMobile ? 250 : 300}>
          <AreaChart data={mockHistoryData} margin={{ top: 5, right: isMobile ? 5 : 20, left: isMobile ? -20 : 0, bottom: 5 }}>
            <defs>
