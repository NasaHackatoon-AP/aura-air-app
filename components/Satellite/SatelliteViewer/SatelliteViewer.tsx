  ...
  return (
    <Card className="col-span-full">
      <CardHeader>
        ...
        <CardDescription>
          Imagens em tempo real de satélites meteorológicos
        </CardDescription>
      </CardHeader>
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                <p className="text-lg font-semibold mb-2">
                  {mockSatellites[selectedSatellite].name}
                </p>
                <Badge variant="secondary" className="mb-2">
                  {mockSatellites[selectedSatellite].type}
                </Badge>
                <p className="text-sm text-muted-foreground">
                  Cobertura: {mockSatellites[selectedSatellite].coverage}
                </p>
                <p className="text-xs text-muted-foreground mt-1">
                  Última atualização:{" "}
                  {mockSatellites[selectedSatellite].lastUpdate}
                </p>
              </div>
              <p className="text-sm text-muted-foreground max-w-md">
                A visualização AR com dados reais da NASA será implementada
                quando o backend estiver integrado com a API da NASA.
              </p>
            </div>
          </div>
