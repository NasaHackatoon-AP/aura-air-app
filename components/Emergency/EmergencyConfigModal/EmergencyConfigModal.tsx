...
export function EmergencyConfigModal({
  ...
  return (
    <MobileOptimizedDialog
      ...
      description="Configure como você deseja receber alertas de emergência e desastres naturais"
    >
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Alert>
              ...
              <AlertDescription>
                O monitoramento automático detecta desastres naturais e alertas
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-lg">Configurações Principais</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <Bell className="h-4 w-4" />
                  <span className="font-medium">Monitoramento Automático</span>
                </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Alert>
              <Info className="h-4 w-4" />
              <AlertDescription>
                Alertas dentro deste raio aparecerão como notificações na tela.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
